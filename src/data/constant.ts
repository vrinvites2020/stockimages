export const weddingInvitationDetails = [{
    ...
    features: [
      "Comprehensive guide covering all aspects of wedding photography",
      "Step-by-step instructions for traditional wedding ceremonies",
      "Tips for capturing candid moments",
      "Equipment recommendations",
      "Post-processing techniques",
      "Client interaction guidelines",
      "Business tips for wedding photographers",
      "Sample shot lists and timelines",
      "File Format: PDF"
    ],
    price: 499,
    language: "Hindi",
